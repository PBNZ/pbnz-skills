...
- **Report a vulnerability:** https://github.com/PBNZ/pbnz-skills/security/advisories/new
...
This policy covers the contents of this repository — the marketplace manifest, plugin manifests, and skills. It does not cover:
...
- Third-party tools that ingest these skills (Cursor, Copilot, Codex, Gemini CLI, Windsurf, etc.). Please report those through each tool's own security channel.
